...
(function(G) {
    ...
    var buildVisitorsPanel = function(geoKey) {
        ...
        str =  {
            ...
            ES: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/all.png" alt="" /></i> Los visitantes hoy: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/now.png" alt="" /></i> Ahora online: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/buy.png" alt="" /></i> Compras de hoy: <span>' + ad1_notify.stat.sales + '</span>');
            },

            PT: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/all.png" alt="" /></i> Visitantes hoje: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/now.png" alt="" /></i> On-line: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/buy.png" alt="" /></i> Compras de Hoje: <span>' + ad1_notify.stat.sales + '</span>');
            },

            RO: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/all.png" alt="" /></i> Vizualizări astăzi: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/now.png" alt="" /></i> Acum online: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/files/_blocks/notificators/img/buy.png" alt="" /></i> Au cumpărat astăzi: <span>' + ad1_notify.stat.sales + '</span>');
            }
        };
    ...
    var AD1 = G.AD1 || {
        ...
        showVisitorsPanel: function() {
            try {
                $('body').prepend(buildVisitorsPanel(ad1_notify.params.geoKey)).addClass('hasVisitorsPanel');
                var $firstMarkupElem = $('#visitors-panel').siblings().not('script').not('link').eq(0);
