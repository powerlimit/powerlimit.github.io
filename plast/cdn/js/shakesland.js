(function(window) {
    ...
    var Requests = function (name, type) {
        ...
        return {
            ...
            parking: {
                tid: '/api/track' + document.location.search + '&code=' + document.location.pathname.split('/')[1],
    ...
    Scripts.prototype.initialize = function() {
        ...
        script.onload = function() {
            ...
            // Old
            // if (GeoInfo && countryList[lCountries.userCountryCode]) {
            //     countryList[lCountries.userCountryCode].cityCurrentHelper = GeoInfo.city;
            // }
            // New
    ...
    if (Helpers.urlGET('ver') && Helpers.urlGET('ver') == 1) {
        // Сценарий паркинга
        ...
        window.lShakes = new Shakes({
            domainType: 'default',
            cookie_domain: 'shak'+'esspot.com',
            cookie_domains: ['shak'+'esspot.com', 'shak'+'escash.com', 'shak'+'esclick.com', 'sha'+'kesin.com', 'shake'+'spoint.com'],
            comeBacker: {
                status: true,
            },
        });
