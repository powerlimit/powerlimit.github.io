...
$(function() {
	...
	$(".typed__message").typed({
			strings: ["", "Нужен сайт?", "У нас есть идеи!"],
			typeSpeed: 100,
			backSpeed: 80,
			backDelay: 2000,
			callback: function() {
				setTimeout(function(){
					$('.main--screen__button a').fadeIn('slow')
				}, 1000);
			}
	...
	$(window).scroll(function(){
		$('.parallax-3').css({'top': 750-$(window).scrollTop()/3});
	})
	...
	$(".menu--link").click(function (event) {
   	...
   	$('#my-menu').mmenu({
		extensions: ['theme-black', 'effect-menu-slide', 'pagedim-black', 'fx-listitems-drop', 'listview-justify'],
		navbar: {
			title: '<i class="fa fa-ravelry" aria-hidden="true"></i> powerlimit'
		},
		offCanvas: {
			position: 'right'
		}
	...
	$(window).scroll(function(){
		if($(window).scrollTop()>0){
			$('.top-line').css({'position':'fixed', 'padding': '0'});
		}else{
			$('.top-line').css({'position':'absolute', 'padding': '10px'});
		}
	});
